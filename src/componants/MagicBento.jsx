...
const cardData = [
  ...
  },
  {
    color: "#060010",
    title: "",
    description: "Hybrid creator bridging design & development",
    label: "Creative Developer",
  },
  {
    color: "#060010",
    title: "",
    description: "Simple, performant software with creativity",
    label: " Mindset",
  },
  {
    color: "#060010",
    title: "",
    description:
      "I thrive in collaborative environments, valuing clear communication and shared goals. I believe that the best digital products are built through collective creativity and mutual support.",
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid gap-2 p-3 max-w-[64rem] mx-auto select-none relative"
    ref={gridRef}
  >
    {children}
  </div>
...
const MagicBento = ({
  ...
  return (
    <>
      <style>
        {`
          .bento-section { --glow-color: ${glowColor}; --border-color: #392e4e; --background-dark: #060010; --white: #ffffff; }
          .card-responsive { display: grid; grid-template-columns: 1fr; width: 100%; gap: 12px; }
          ...
          .card--border-glow::after {
            ...
            background: radial-gradient(var(--glow-radius) circle at var(--glow-x) var(--glow-y), rgba(${glowColor}, calc(var(--glow-intensity) * 0.8)), transparent 60%);
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-start gap-1 relative aspect-[4/3] min-h-[200px] w-full p-6 rounded-[24px] border border-solid transition-all duration-300 ${
