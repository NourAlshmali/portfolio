...
const About = () => {
  return (
    ...
    >
      ...
      <div className="relative flex flex-col lg:flex-row justify-center items-center gap-10 mt-10 w-full h-auto lg:h-[80vh] lg:pl-20">
        
     
        <div className="w-full lg:w-1/3 flex justify-center">
      
          <div className="border-2 border-purple-400 rounded-3xl p-1 w-full max-w-[300px] sm:max-w-[350px] md:max-w-[380px] lg:max-w-[480px] h-[400px] sm:h-[480px] lg:h-[500px] flex items-center justify-center">
            <img
              src={me}
              alt="Profile"
